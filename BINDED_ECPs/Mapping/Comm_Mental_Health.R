...
ggmap(co_map, extent = "device") +
  ...
  xlab(" ") +
  ylab(NULL) +
  ggtitle('2018 Colorado "Community Mental Health Centers" Providers & Facilities') +
  ...
  theme(plot.margin = margin(5, 5, 5, 5),
        ...
        plot.caption = element_text(family = "Arial",
                                    ...
                                    color = "grey50",
                                    hjust = 0.5)) +
  ggsave(filename = "BINDED_ECPs/Plots/COMM_MENTAL_HLTH.png", width = 9, height = 4, dpi = 1200)

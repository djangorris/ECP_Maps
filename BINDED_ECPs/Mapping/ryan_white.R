...
# FILTER CATEGORY
CO_ALL_ECP_BIND_RYAN_WHITE <- filter(CO_ALL_ECP_BIND,
                                                  ECP_Category == "Ryan White Providers")
# DISPLAY MAP AND ADD DATA POINTS
ggmap(co_map, extent = "device") +
  # geom_density2d(data = CO_ALL_ECP_BIND_RYAN_WHITE,
  #                aes(x = lon, y = lat),
  #                size = 0.3) +
  # stat_density2d(data = CO_ALL_ECP_BIND_RYAN_WHITE,

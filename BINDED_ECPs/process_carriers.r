...
write_csv(CO_all_dental_carriers, path = "Individual_ECPs/Processed_CSV/CO_all_dental_carriers.csv")
write_csv(CO_all_carrier_count, path = "Individual_ECPs/Processed_CSV/CO_all_carrier_count.csv")
write_csv(county_all_carrier_count, path = "Individual_ECPs/Processed_CSV/county_all_carrier_count.csv")

...
ggmap(co_map, extent = "device") +
  ...
  xlab(" ") +
  ylab(NULL) +
  ggtitle("2018 Colorado Federally Qualified Health Centers (Individual ECPs)") +
  ...
  theme(plot.margin = margin(5, 5, 5, 5),
        ...
        plot.caption = element_text(family = "Arial",
                                    ...
                                    color = "grey50",
                                    hjust = 0.5)) +
  ggsave(filename = "Individual_ECPs/Plots/heatmap_statewide_fed_qualified.png", width = 9, height = 8, dpi = 1200)

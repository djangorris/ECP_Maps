...
ggmap(co_map, extent = "device") +
  ...
  xlab(" ") +
  ylab(NULL) +
  ggtitle("2018 Colorado Statewide Federally Qualified Health Centers") +
  ...
  ggsave(filename = "Individual_ECPs/Plots/heatmap_statewide_fed_qualified.png", width = 12, height = 8, dpi = 1200)

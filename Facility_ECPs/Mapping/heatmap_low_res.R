...
CO_all_facility_carrier_count_HEMOPHILIA <- filter(CO_all_facility_carrier_count,
                                               ECP_Category == "Hemophilia Treatment Centers")
...
ggmap(co_map, extent = "device") +
  ...
  xlab(" ") +
  ylab(NULL) +
  ggtitle("2018 Colorado Statewide Hemophilia Treatment Centers") +
  ...
  ggsave(filename = "Individual_ECPs/Plots/heatmap_statewide_HEMOPHILIA.png", width = 12, height = 8, dpi = 1200)
